...
Although it supports the right of every person to believe whatever they wish, Deirenism appraises beliefs and classifies them into one of three categories: axiom, allegory, and delusion. In Deirenism, axioms are rational, empirical, or scientific and consistent with common sense, empirical observations, scientific knowledge, or historical facts. If an axiom is accepted as true by consensus, Deirenism describes it as a logical axiom. Ideally, logical axioms will be regarded as true regardless of context, but if an axiom is ever challenged, it can be called a postulate or an assumption.

and thus considered to be a tautology. and can be logical axioms and Building on the definition of axioms as ideas that either are accepted as true by consensus or serve as the premise or basis for further discussion or reasoning, Deirenism considers axioms are  In contrast to axioms, allegories are essentially fictional stories that may hold valuable lessons, but should never be used for reasoning and interpreted literally.
