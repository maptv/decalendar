...
Although Deirenism supports the right of every person to believe whatever they wish, it does not consider all beliefs to be equal. Rational, empirical, scientific, or self-evident beliefs are called axioms in Deirenism. In contrast to axioms, beliefs that are irrational, unempirical, unscientific, or untrue are referred to as allegories by Deirenism. Axioms and allegories duality To minimize cognitive burden, Deirenism only includes beliefs that it considers to be axioms. To limit cognitive dissonance,  beliefs that either are accepted as true by consensus or serve as the premise or basis for further discussion or reasoning. To differentiate axioms from allegories and delusions, Deirenism describes axioms as . According to this definition,   beliefs As opposed to allegories and delusions, axioms can be interpreted literally without contradicting common sense, empirical observations, scientific knowledge, or historical facts. 
