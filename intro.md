...
Although Deirenism supports the right of every person to believe whatever they wish, it appraises beliefs by classifying them as axioms, allegories, or delusions. Axioms are beliefs that either are accepted as true by consensus or serve as the premise or basis for further discussion or reasoning. To differentiate axioms from allegories and delusions, Deirenism describes axioms as rational, empirical, scientific, or self-evident beliefs. According to this definition,  irrational, unempirical, unscientific, or untrue beliefs As opposed to allegories and delusions, axioms can be interpreted literally without contradicting common sense, empirical observations, scientific knowledge, or historical facts. 
