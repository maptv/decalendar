...
Inputs.button("Copy current timestamp", {value: null, reduce: () => navigator.clipboard.writeText(unix2deco(new Date().getTime()).slice(0, 14))})
```
