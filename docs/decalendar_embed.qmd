...
{{< embed decalendar_javascript.ipynb#datestamp echo=true >}}

##### `date` timestamp

{{< embed decalendar_javascript.ipynb#dotystamp echo=true >}}

#### Julia

##### `doty` timestamp

{{< embed decalendar_julia.ipynb#datestamp echo=true >}}

##### `date` timestamp

{{< embed decalendar_julia.ipynb#dotystamp echo=true >}}

#### Python

##### `doty` timestamp

{{< embed decalendar_python.ipynb#datestamp echo=true >}}

##### `date` timestamp

{{< embed decalendar_python.ipynb#dotystamp echo=true >}}

#### R

##### `doty` timestamp

{{< embed decalendar_r.ipynb#datestamp echo=true >}}

##### `date` timestamp

{{< embed decalendar_r.ipynb#dotystamp echo=true >}}
...
const [year, doty, time] = unix2doty(Date.now()),
    datetime = `${year.toString().padStart(4, "0")}+${
        ...
        (Math.round(time * 1e5)).toString().padStart(5, "0")}${hour2zone()}`;
