...
<iframe width="100%" height="105" frameborder="0"
  src="https://observablehq.com/embed/@decalender/decalendar@103?cells=pageLoadTimestamp"></iframe>

In addition to being much easier to read, `doty` numbers make working with dates a breeze🎐. Use the input below to add numbers to the current year and `doty`. Try adding both positive and negative numbers to see both future and past dates. You can even use decimal `doty` numbers and decimal years! ✨🤩✨ For example, the year `1969.84` is equivalent to the date `1969+306`.
