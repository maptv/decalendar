...
styledDime = setStyle(dotyTime[0], d3.schemePaired[6])
styledCent = setStyle(dotyTime[1], d3.schemePaired[11])
styledMil = setStyle(dotyTime[2], d3.schemePaired[9])
styledPhrase = setStyle(dotyTime[3], d3.schemePaired[8])
styledBeat = setStyle(dotyTime[4], d3.schemeAccent[5])
