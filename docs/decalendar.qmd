...
![The components of a day-of-the-year (`doty`)](fig-doty.png){#fig-doty fig-alt="A 4-digit number with 3 digits before the decimal and 1 digit after the decimal. The three digits before the decimal are labeled 'January 1st'. The digit after the decimal is labeled 'Midnight'." fig-align="center"}
