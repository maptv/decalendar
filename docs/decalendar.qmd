...
Interestingly, years from negative `deco` dates do not need any adjustment. The first day of the `Decalendar` year, `Day 0`, is March 1 in the Gregorian calendar. Starting the year on March 1 The last day of `Year 1999` is `1999+365` or `2000-001` in `Decalendar` and February 29, 2000 in the Gregorian calendar. `Year 1999` is thus a leap year from the perspective of the positive `deco` date, while `Year 2000` is the leap year from the point-of-view of the negative `deco` date and the Gregorian calendar date.
