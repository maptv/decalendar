...
"$(lpad(date2year(), 4, '0'))+$(lpad(date2doty(), 3, '0')).$(
    lpad(Int(round(time2doty(0) * 1e5)), 5, '0'))$(hour2zone())"
...
function unix2doty(s=0, ms=0)
    ...
    year, doty, timestamp - doty
end

y, d, t = unix2doty(time())
"$(lpad(y, 4, '0'))+$(lpad(d, 3, '0')).$(lpad(Int(round(t * 1e5)), 5, '0'))$(hour2zone())"
```
