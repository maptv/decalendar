...
<div id="observablehq-doty-101bd11f"></div>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@observablehq/inspector@5/dist/inspector.css">
<script type="module">
import {Runtime, Inspector} from "https://cdn.jsdelivr.net/npm/@observablehq/runtime@5/dist/runtime.js";
import define from "https://api.observablehq.com/@dec/dec@244.js?v=3";
new Runtime().module(define, name => { if (name === "doty") return new Inspector(document.querySelector("#observablehq-doty-101bd11f")); });
</script>
