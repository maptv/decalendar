...
![The components of a Decalendar date](fig-date.png){#fig-glance fig-alt="A date consisting a year and a day of the year separated by a plus sign. The first two digits of the day of the year are labeled as the dek, while the last digit is labeled as the day of the dek."}
...
![The components of a Decalendar time](fig-time.png){#fig-glance fig-alt="A time shown as a five-digit number with a one-letter time zone code at the end. The first digit is labeled 'dimes', the first two 'cents', the first three 'mils', and all five 'beats'."}
