...
def unix2doty(s=0, ms=0):
    ...
    year = int(yoe + era * 400)
    timestamp = days - (year * 365 + year / 4 - year / 100 + year / 400).__floor__()
    doty = int(timestamp.__floor__())
    return year, doty, timestamp - doty
...
unix2doty <- function(s = 0, ms = 0) {
  ...
  paste0(sprintf("%04d", year),
         ...
         sprintf("%03d", doty),
         ".",
         sprintf(paste0("%0", precision, "d"), round(timestamp - doty)))
}
