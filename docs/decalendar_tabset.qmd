...
### Page load timestamp {#sec-demo-load}
...
This `Decalendar` timestamp increments every one ten thousandth ($10^{-5}$) of a day (centimilliday), which is `Decalendar` is called a `beat`.
