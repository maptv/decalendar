...
The current `doty` date and time is shown in @exm-doty. The code used to create @exm-doty is also available in the [Observable](https://observablehq.com/) notebook version of this document: <https://observablehq.com/@dec/dec>.
