...
function doty2deco(year = 1969, doty = 306, zone = 0) {
    ...
    return `${yd[0].toString().padStart(4, "0")}+${
        yd[1].toString().padStart(3, "0")}${
...
Any `doty` can be combined with a year to form a `Decalendar` ordinal date (`deco`). Enter a year, month, `dotm`, hour, and minute below to see the equivalent `deco` (`year+day.ddd`): \${dtYear}+\${dtDotyDate}.\${dtDotyTime}.
