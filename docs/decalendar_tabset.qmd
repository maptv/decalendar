...
If subtract the second timestamp from the first, we can see how long this page has been open. You don't have to read it all in one sitting, so please feel free to take breaks😄.
