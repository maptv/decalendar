...
You can also enter a year and a `doty` to get year, month, `dotm`, hour, minute, and second values:

```{ojs}
viewof inputYear = Inputs.number({label: "Year", value: 1969})
```

```{ojs}
viewof inputDoty1 = Inputs.range([0, 365], {label: "Doty", value: 306})
```
